...
# TODO LRB print CRT <<EOT;
# TODO LRB ##
# TODO LRB ## Bundle of CA Root Certificates
# TODO LRB ##
# TODO LRB ## Certificate data from Mozilla ${datesrc}: ${currentdate} GMT
# TODO LRB ##
# TODO LRB ## This is a bundle of X.509 certificates of public Certificate Authorities
# TODO LRB ## (CA). These were automatically extracted from Mozilla's root certificates
# TODO LRB ## file (certdata.txt).  This file can be found in the mozilla source tree:
# TODO LRB ## ${url}
# TODO LRB ##
# TODO LRB ## It contains the certificates in ${format}PEM format and therefore
# TODO LRB ## can be directly used with curl / libcurl / php_curl, or with
# TODO LRB ## an Apache+mod_ssl webserver for SSL client authentication.
# TODO LRB ## Just configure this file as the SSLCACertificateFile.
# TODO LRB ##
# TODO LRB ## Conversion done with mk-ca-bundle.pl version $version.
# TODO LRB ## SHA256: $newhash
# TODO LRB ##
# TODO LRB 
# TODO LRB EOT
...
while (<TXT>) {
  ...
  if ($start_of_cert && /^CKA_VALUE MULTILINE_OCTAL/) {
    ...
    if ( !should_output_cert(%trust_purposes_by_level) ) {
      ...
      # TODO LRB print CRT "\n$caname\n";
      # TODO LRB print CRT @precert if($opt_m);
      ...
      # TODO LRB print CRT ("=" x $maxStringLength . "\n");
      if (!$opt_t) {
        print CRT $pem;
      } else {
        my $pipe = "";
